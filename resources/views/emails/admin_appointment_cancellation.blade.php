...
<head>
    ...
    <title>Lịch hẹn xem nhà đã bị hủy</title>
    <style>
        ...
        .btn { display: inline-block; background-color: #64748b; color: #ffffff !important; padding: 12px 24px; font-size: 13px; font-weight: 700; text-decoration: none; border-radius: 8px; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>⚠️ LỊCH HẸN XEM NHÀ ĐÃ BỊ HỦY</h1>
        </div>
        <div class="content">
            <h2 class="welcome">Xin chào Ban Quản Trị,</h2>
            <p class="desc">Hệ thống BDS Rental vừa ghi nhận một thông báo hủy lịch hẹn xem nhà từ phía khách hàng. Dưới đây là thông tin chi tiết:</p>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value" style="color: #ef4444; font-weight: bold;">Khách thuê hủy lịch hẹn</td>
                </tr>
            </table>

            <div class="btn-container">
                <a href="{{ url('/admin/appointments') }}" class="btn">Quản lý lịch hẹn</a>
            </div>
        </div>
        <div class="footer">
