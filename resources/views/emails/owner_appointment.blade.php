...
<head>
    ...
    <title>Khách hàng đặt lịch xem nhà</title>
    <style>
...
<body>
    <div class="container">
        <div class="header">
            <h1>📅 YÊU CẦU ĐẶT LỊCH XEM NHÀ MỚI</h1>
        </div>
        <div class="content">
            <h2 class="welcome">Xin chào {{ $appointment->property->owner->name }},</h2>
            <p class="desc">Bạn có một yêu cầu hẹn xem nhà mới cho tin đăng của mình trên hệ thống BDS Rental. Dưới đây là thông tin chi tiết:</p>
            ...
            <table class="details-table">
                ...
                <tr>
                    ...
                    <td class="value">
                        <a href="tel:{{ $appointment->phone }}" style="color: #0077bb; font-weight: bold; text-decoration: none;">{{ $appointment->phone }}</a>
                    </td>
                </tr>
                <tr>
            ...
            <p class="desc">Vui lòng chủ động liên lạc trực tiếp với khách hàng theo số điện thoại ở trên để xác nhận buổi xem nhà.</p>

            <div class="btn-container">
                <a href="{{ url('/profile?tab=appointments') }}" class="btn">Xem danh sách lịch hẹn của tôi</a>
            </div>
        </div>
        <div class="footer">
