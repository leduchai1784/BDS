...
<head>
    ...
    <title>Xác nhận yêu cầu xem nhà</title>
    <style>
        ...
        .agent-card { background-color: #e0f2fe; border: 1px solid #bae6fd; border-radius: 12px; padding: 16px; margin-top: 24px; margin-bottom: 24px; }
...
<body>
    <div class="container">
        <div class="header">
            <h1>🏠 ĐẶT LỊCH HẸN XEM NHÀ THÀNH CÔNG</h1>
        </div>
        <div class="content">
            <h2 class="welcome">Xin chào {{ $appointment->name }},</h2>
            <p class="desc">Cảm ơn bạn đã sử dụng dịch vụ của BDS Rental. Yêu cầu đặt lịch hẹn xem bất động sản của bạn đã được ghi nhận thành công. Dưới đây là thông tin chi tiết lịch hẹn:</p>
            ...
            <div class="agent-card">
                <h3 class="agent-title">👤 Thông tin Chủ nhà / Môi giới phụ trách:</h3>
            ...
            <p class="desc" style="font-size: 12px; color: #64748b;">Chủ nhà hoặc người phụ trách sẽ chủ động liên hệ trực tiếp với bạn qua số điện thoại <strong>{{ $appointment->phone }}</strong> để xác nhận trước khi cuộc hẹn diễn ra.</p>
