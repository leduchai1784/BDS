        ...
        <div class="space-y-1">
            ...
            <div class="relative">
                ...
                >
                    ...
                    <option value="Phòng trọ" {{ old('type', $property->type) == 'Phòng trọ' ? 'selected' : '' }}>Phòng trọ</option>
                    <option value="Đất" {{ old('type', $property->type) == 'Đất' ? 'selected' : '' }}>Đất</option>
                    <option value="Mặt bằng" {{ old('type', $property->type) == 'Mặt bằng' ? 'selected' : '' }}>Mặt bằng</option>
                    <option value="Văn phòng" {{ old('type', $property->type) == 'Văn phòng' ? 'selected' : '' }}>Văn phòng</option>
                    <option value="Kho, nhà xưởng" {{ old('type', $property->type) == 'Kho, nhà xưởng' ? 'selected' : '' }}>Kho, nhà xưởng</option>
                </select>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="space-y-1">
                    ...
                    <input 
                        ...
                        step="0.01"
                        name="frontage" 
                        value="{{ old('frontage', $property->frontage) }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="space-y-1">
                    ...
                    <input 
                        type="text" 
                        name="lease_term" 
                        value="{{ old('lease_term', $property->lease_term) }}"
