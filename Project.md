...
* **Khách thuê / Khách mua (Tenant)**:
  ...
  * Đặt lịch hẹn xem nhà trực tiếp (nhập Họ tên, SĐT, Email, Ngày & Giờ, Ghi chú) và tự động nhận email xác nhận khi đặt hoặc hủy lịch.
  * Lưu trữ danh sách tin đăng yêu thích (Wishlist).
  * **Đăng ký làm chủ nhà**: Nhập thông tin cơ bản (Họ tên, SĐT, Tên công ty) để nâng cấp tài khoản từ Khách thuê thành Đối tác Chủ nhà ngay lập tức.
* **Chủ nhà / Môi giới (Owner)**:
  ...
  * Nhận email thông báo khi có khách đặt/hủy lịch hẹn xem nhà để chủ động liên hệ.
...
* **Quản trị viên (Admin)**:
  ...
  * Nhận email thông báo khi có bất kỳ lịch hẹn xem nhà mới hoặc lịch hẹn bị hủy trên hệ thống.
...
* **Thông tin cá nhân tinh giản**: Loại bỏ trường nhập liệu "Nơi sinh" (pob) khỏi biểu mẫu thông tin cá nhân chung để biểu mẫu gọn gàng và thẩm mỹ hơn, đồng thời tích hợp logic tự động bảo toàn dữ liệu `pob` sẵn có trong cơ sở dữ liệu khi người dùng cập nhật hồ sơ cá nhân.
