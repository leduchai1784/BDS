      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {activeArticles.map((article, idx) => (
            <div 
              key={idx}
              className="bg-white rounded-[24px] overflow-hidden border border-slate-100 hover:shadow-lg transition-all duration-300 flex flex-col h-full cursor-pointer"
            >
              ...
              <div className="p-4 flex flex-col flex-grow text-left">
                ...
                <h4 className="text-xs font-bold text-slate-800 line-clamp-3 hover:text-primary transition duration-150 leading-snug mb-2 flex-grow">
                  {article.title}
                </h4>
              </div>
            </div>
