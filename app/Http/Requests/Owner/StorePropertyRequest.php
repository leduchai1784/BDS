...
class StorePropertyRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => 'required_without:image_url|nullable|image|mimes:jpeg,png,jpg,webp|max:3072',
    ...
    public function messages(): array
    {
        return [
            ...
            'image.required_without' => 'Vui lòng tải lên ảnh đại diện hoặc nhập liên kết ảnh.',
            'image_url.required_without' => 'Vui lòng tải lên ảnh đại diện hoặc nhập liên kết ảnh.',
